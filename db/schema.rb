...
ActiveRecord::Schema.define(version: 20161104074300) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at",                                                                                                                   null: false
    t.datetime "updated_at",                                                                                                                   null: false
    t.string   "image_url",       default: "http://res.cloudinary.com/flikr/image/upload/c_scale,h_195/v1478245250/profile_avatar_aiyfxi.png"
